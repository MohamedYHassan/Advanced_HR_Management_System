...
if(isset($_POST['Receiver']) && isset($_POST['Subject']) && isset($_POST['Message'])) {
    ...
    $email->setReceiverEmail($_POST['Receiver']);
    $email->setSubject($_POST['Subject']);
    $email->setMessage($_POST['Message']);
    $email->setSenderEmail($_POST['Sender']);
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-12">
                    ...
                    <p>Send an Email to your co-workers.</p>
                    <?php
                    ...
                    <div class="form-group">
                            ...
                            <input type="hidden" name="Sender" class="form-control" placeholder="To@example.com" value="<?php echo trim($_SESSION["email"]) ?>">
                        </div>
                        <div class="form-group">
                            <label>To</label>
                            <input type="text" name="Receiver" class="form-control" placeholder="To@example.com">
                        </div>
                        <div class="form-group">
                            <label>Subject</label>
                        ...
                        <a href="email.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
      </div>
