...
$employee = $EmployeeController->getEmp($_POST['id']);
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Employee: <?php echo $employee[0]["Name"] ?></h4>
                  <a href="employee.php" class=" col-md-3 btn btn-primary float-end">
                  <span class="tf-icons bx bx-add-to-queue"></span> Go back
                </a>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $employee[0]["Id"] ?></strong></td>
                          <td><?php echo $employee[0]["Name"] ?></td>
                          <td><?php echo $employee[0]["E-mail"] ?></td>
                          <td><?php echo $employee[0]["Username"] ?></td>
                          <td><?php echo $employee[0]["Password"] ?></td>
                          <td><?php echo $employee[0]["Birth_date"] ?></td>
                          <td><?php echo $employee[0]["Gender"] ?></td>
                          <td><?php echo $employee[0]["Address"] ?></td>
                          <td><?php echo $employee[0]["Mobile"] ?></td>
