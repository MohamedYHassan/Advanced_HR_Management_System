...
$id = $_POST["Id"];
 if(isset($_POST['yes'])){
$HolidayController->deleteHoliday($id);
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-12">
                    <h2 class="mt-5 mb-3">Delete Holiday info</h2>
                    <form action="delete_holiday.php" method="post">
                        <div class="alert alert-danger">
                            <input type="hidden" name="Id" value="<?php echo trim($_POST["Id"]); ?>"/>
                            <p>Are you sure you want to delete this holiday record?</p>
                            <p>
                                <input type="submit" value="Yes" class="btn btn-danger" name="yes">
                                <input  type="submit" name="no" class="btn btn-secondary ml-2" value = 'No'> 
                            </p>
                        </div>
                    </form>
                </div>
