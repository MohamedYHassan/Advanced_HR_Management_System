...
$employees = $EmployeeController->getPayroll();
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Company Payroll</h4>
                  
                  <p class="card-description">
                  Brief look at the payroll of the company.
                  </p>
                  ...
                  <table class="table table-hover">
                    ...
                    ?>
                        ...
                        <tr>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $employee["Id"] ?></strong></td>
