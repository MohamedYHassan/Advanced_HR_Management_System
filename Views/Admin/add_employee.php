...
if(isset($_POST['name']) && isset($_POST['email']) && isset($_POST['username']) && isset($_POST['password']) && isset($_POST['birthdate']) && isset($_POST['gender']) && isset($_POST['address']) && isset($_POST['mobile']) && isset($_POST['position']) && isset($_POST['salary'])) {
  if(!empty($_POST['name']) && !empty($_POST['email']) && !empty($_POST['username']) && !empty($_POST['password']) && !empty($_POST['birthdate']) && !empty($_POST['gender']) && !empty($_POST['address']) && !empty($_POST['mobile']) && !empty($_POST['position']) && !empty($_POST['salary'])) {
      ...
      <div class="col-md-12">
                    ...
                    <form action="add_employee.php" method="post">
                      ...
                      <label for="exampleSelectGender">Gender</label>
                        ...
                        <div class="form-group">
                            <label>Address</label>
                            <input name="address" class="form-control" type="text" placeholder="Address"></input>
                        ...
                        <div class="form-group">
                            ...
                            <option>Department Specialist</option>
