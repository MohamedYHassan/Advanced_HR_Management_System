...
$errMsg="";
$employees = $EmployeeController->getPayrollOverview();
$leaves = $LeaveController->getLeavesAdminOverview();
                              ...
                              <div class="card-body" style="height: 100px;">
                                <div class="d-sm-flex justify-content-between align-items-start">
                                  ...
                                  <?php
                                     ...
                                     ?>
                                  <div>
                                    <a role="button" class="btn btn-primary btn-lg text-white mb-0 me-0" type="button" href="payroll.php">View Payroll</a>
                                  </div>
                                </div>
                                <div class="table-responsive  mt-1">
                                  <table class="table select-table">
                                    ...
                                    <?php
                                      ...
                                      <td style="padding-left: 0px; color: black;" ><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $employee["Id"] ?></strong></td>
                          <td style="color: black;"><?php echo $employee["Name"] ?></td>
                          <td style="color: black;">
                            <?php echo $employee["Position"] ?>
                          </td>
                          <td style="color: black;"><span ><?php echo $employee["Salary"] ?></span></td>
                                  ...
                                  <div class="wrapper w-100">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                      <div class="d-flex align-items-center">
                                        ...
                                        <p class="mb-0 text-small text-muted"> <?php echo $leave['Employee_Id'] ?></p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
