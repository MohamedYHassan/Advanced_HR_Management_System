...
if(isset($_POST['name']) && isset($_POST['taxID']) && isset($_POST['location']) && isset($_POST['foundingYear']))
{
...
<body>
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-12">
                    <h2 class="mt-5">Update Company</h2>
                    <p>Please edit this form and submit to update company record in the database.</p>
                    <form action="update_company.php" method="post">
                    <div class="form-group">
                            <label>Tax ID Number</label>
                            <input type="text" readonly class="form-control" name="taxID" value="<?php echo trim($company->getTaxIDNumber()) ?>">
                        </div>
                        <div class="form-group">
                        
                            <label>Name</label>
                            <input type="text" name="name" class="form-control" placeholder="Name" value=" <?php echo  trim($company->getName());?> ">
                        </div>
                        <div class="form-group">
                            <label>Location</label>
                            <input type="text" name="location" class="form-control" placeholder="Location" value=" <?php echo trim($company->getLocation()) ?> ">
                        </div>
                        <div class="form-group">
                            <label>Founding Year</label>
                            <input type="text" name="foundingYear" class="form-control" placeholder="Founding Year" value=" <?php echo trim($company->getFoundingYear()) ?> ">
                        </div>
