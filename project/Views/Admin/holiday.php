...
$errMsg = "";
$holidays = $holidayController->getHoliday();
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php
              if (count($holidays) == 0) {
              ?>
                <div class="alert alert-danger" role="alert">No Available Holidays</div>
              <?php
              }
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="add_holiday.php" class=" col-md-3 btn btn-primary float-end">
                  <span class="tf-icons bx bx-add-to-queue"></span> Add Holiday
                </a>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          <td style="padding-left: 0px;"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $holiday["Id"] ?></strong></td>
                          <td><?php echo $holiday["Name"] ?></td>
                          <td>
                            <?php echo $holiday["Date"] ?>
                          </td>
                          <td id="action" style="padding-right: 0px; padding-left: 0px;">
                            ...
                            <form action="update_holiday.php" method="POST">
                              ...
                              <input type="hidden" name="Name" value="<?php echo $holiday["Name"] ?>">
                  ...
                  <a href="generate_holiday_pdf.php" class=" col-md-3 btn btn-primary float-end sty">Generate PDF</a>
                </div>
