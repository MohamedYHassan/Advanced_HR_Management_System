  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <?php
              ...
              ?>
                <div class="alert alert-danger" role="alert">No Available Employees</div>
              <?php
              } 
...
<div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a href="add_employee.php" class=" col-md-3 btn btn-primary float-end">
                  <span class="tf-icons bx bx-add-to-queue"></span> Add New Employee
            </a>
                  
                
                  
                  <p class="card-description">
                  Brief look at the employees.
                  </p>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          <td style="padding-left: 0px;"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $employee["Id"] ?></strong></td>
                          <td><?php echo $employee["Name"] ?></td>
                          <td>
                            <?php echo $employee["Position"] ?>
                          </td>
                          <td><span ><?php echo $employee["Salary"] ?></span></td>
                          <td id="action" style="padding-right: 0px; padding-left: 0px;">
                            ...
                            <form action="update_employee.php" method="POST">
                              ...
                              <input type="hidden" name="email" value="<?php echo $employee["E-mail"] ?>">
                              <input type="hidden" name="username" value="<?php echo $employee["Username"] ?>">
                              <input type="hidden" name="password" value="<?php echo $employee["Password"] ?>">
                              <input type="hidden" name="birthdate" value="<?php echo $employee["Birth_date"] ?>">
                              <input type="hidden" name="gender" value="<?php echo $employee["Gender"] ?>">
                              <input type="hidden" name="address" value="<?php echo $employee["Address"] ?>">
                              <input type="hidden" name="mobile" value="<?php echo $employee["Mobile"] ?>">
                              <input type="hidden" name="position" value="<?php echo $employee["Position"] ?>">
                  ...
                  <a href="generate_employee_pdf.php" class=" col-md-3 btn btn-primary float-end sty">Generate PDF</a>
                </div>
