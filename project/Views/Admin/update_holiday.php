...
$holiday->setID($_POST['Id']);
    $holiday->setName($_POST['Name']);
    $holiday->setDate($_POST['Date']);
    ...
    if(isset($_POST['submit']) && !empty($_POST['Name'])) {
      ...
      $HolidayController->updateHoliday($holiday);
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
            ...
            <div class="col-md-12">
                    <h2 class="mt-5">Update Holiday</h2>
                    <p>Please edit this form and submit to update holiday record in the database.</p>
                    <?php  if(isset($_POST["submit"]) && $errMsg == true )   echo '<div class="alert alert-danger" role="alert"> Please fill all fields</div>' ?>
                    <form action="update_holiday.php" method="post">
                    <div class="form-group">
                            <label>Holiday ID</label>
                            <input type="text" readonly class="form-control" name="Id" value="<?php echo trim($holiday->getID()) ?>">
                        </div>
                        <div class="form-group">
                        
                            <label>Name</label>
                            <input type="text" name="Name" class="form-control" placeholder="Name" value=" <?php echo  trim($holiday->getName()) ?> ">
                        </div>
                        <div class="form-group">
                            <label>Date</label>
                            <input type="date" name="Date" class="form-control" placeholder="Date" value=" <?php echo trim($holiday->getDate()) ?> ">
                        </div>
                        
                        
                        <input type="submit" class="btn btn-primary" value="Submit" name="submit" >
                        <a href="holiday.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
