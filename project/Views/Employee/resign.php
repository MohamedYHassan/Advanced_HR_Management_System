...
if(isset($_POST['Receiver']) && isset($_POST['Subject']) && isset($_POST['Message'])) {
    ...
    $email->setSenderEmail($_POST['Sender']);
     ...
     $EmployeeController->deleteEmployee($_SESSION['Id']);
        header("location: ../Auth/login.php");
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-12" style="margin-left: 40px;">
                    <h2 class="mt-5">Send Resignation Email</h2>
                   
                    <p>Your Resignation Email .</p>
                    <?php
                    ...
                    <div class="form-group">
                            ...
                            <input type="hidden" name="Sender" class="form-control" value="<?php echo trim($_SESSION["email"]) ?>">
                        </div>
                        <div class="form-group">
                            <label>To</label>
