  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Hello: <?php echo $_SESSION['name'] ?></h4>
                  <a href="index.php" class=" col-md-3 btn btn-primary float-end">
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                        ...
                        <tr>
                          <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $_SESSION["Id"] ?></strong></td>
