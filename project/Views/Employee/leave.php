...
$errMsg = "";
$leaves = $LeaveController->getLeavesEmployee();

$id = $_POST["id"];

$leaveLimit = 3; // Set your leave limit
$pendingLeavesCount = $LeaveController->getPendingLeavesCount($_SESSION['Id']); // Add a method to get pending leaves count

echo count($pendingLeavesCount)
        ...
        <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php
                  if(count($pendingLeavesCount) < $leaveLimit) {
                    ?>
                  
                      <a href="add_leave.php" class=" col-md-3 btn btn-primary float-end">
                        <span class="tf-icons bx bx-add-to-queue"></span> Request Leave
                      </a>
                      <?php 
                  } else {
                    ?>
                    <div class="alert alert-danger" role="alert">Leaves Requests Limit Exceeded!</div>
                    <?php
                    }
                    ?>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      ?>
                        <tr>
                          <td style="padding-left: 0px;"><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?php echo $leave["Leave_Id"] ?></strong></td>
