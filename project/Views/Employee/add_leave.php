...
if(isset($_POST['Name']) && isset($_POST['Reason'])) {
    if( !empty($_POST['Name']) && !empty($_POST['Reason'])) {

    $leave = new Leave;
    
    $leave->setName($_POST['Name']);
    $leave->setReason($_POST['Reason']);
   
     $LeaveController->addLeave($leave);
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="col-md-12" style="margin-left: 40px;">
                    ...
                    <p>Please fill this form and submit to request a leave.</p>
                    <?php
                    ...
                    <form action="add_leave.php" method="post">
                        ...
                        <a href="leave.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
      </div>
